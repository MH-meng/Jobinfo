# -*- coding: utf-8 -*-
# Generated by Django 1.11.10 on 2018-10-24 01:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('c_name', models.CharField(max_length=64, verbose_name='企业名')),
                ('c_number', models.CharField(max_length=11, verbose_name='账号')),
                ('c_pwd', models.IntegerField(verbose_name='密码')),
                ('c_nature', models.CharField(blank=True, max_length=64, null=True, verbose_name='单位性质')),
                ('c_city', models.CharField(blank=True, max_length=36, null=True, verbose_name='所在城市')),
                ('c_industry', models.CharField(blank=True, max_length=64, null=True, verbose_name='单位行业')),
                ('c_scale', models.IntegerField(blank=True, default=0, null=True, verbose_name='单位规模')),
                ('c_brief', models.TextField(blank=True, max_length=1000, null=True, verbose_name='单位简介')),
                ('c_phone', models.CharField(blank=True, max_length=11, null=True, verbose_name='招聘电话')),
                ('c_linkman', models.CharField(blank=True, max_length=12, null=True, verbose_name='联系人')),
        ...
        migrations.AddField(
            model_name='article',
            name='tags',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='info.Tag'),
        ),
    ]

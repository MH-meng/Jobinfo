# Generated by Django 2.1.5 on 2019-04-11 08:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('f_image_url', models.CharField(blank=True, max_length=255, null=True)),
                ('f_parse_url', models.CharField(blank=True, max_length=255, null=True)),
                ('f_create_time', models.DateTimeField(auto_now_add=True, null=True)),
                ('f_code_img', models.CharField(blank=True, max_length=120, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Conpanys',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('snumber', models.CharField(max_length=11, verbose_name='账号')),
                ('spwd', models.CharField(max_length=64, verbose_name='密码')),
                ('sname', models.CharField(max_length=11)),
                ('sgender', models.CharField(blank=True, max_length=2, null=True)),
                ('sborthday', models.DateTimeField(blank=True, null=True)),
                ('sphone', models.CharField(blank=True, max_length=11, null=True, verbose_name='电话')),
                ('sstatus', models.CharField(default='0', max_length=3)),
                ('startwork', models.DateTimeField(blank=True, null=True)),
                ('sarea', models.CharField(blank=True, max_length=24, null=True)),
                ('semail', models.EmailField(blank=True, max_length=254, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('x_company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                                to='info.Conpanys')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wstudentid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='info.StudentInfo')),
            ],
        ),
        migrations.CreateModel(
            name='Zhaopin',
            fields=[
                ...
                ('z_company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                                to='info.Conpanys')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='pstudentid',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='info.StudentInfo'),
        ),
        migrations.AddField(
            model_name='jobintension',
            name='jstudentid',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='info.StudentInfo'),
        ),
        migrations.AddField(
